...
let h1 = document.querySelector('h1:code_explained')
// h1.innerHTML = 'text'
const btn = document.querySelector('button:click-to-show-code')

btn.addEventListener('click', h1.innerHTML = code_explained)